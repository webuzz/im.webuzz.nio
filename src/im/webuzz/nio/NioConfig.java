...
public class NioConfig {
	...
	// < 0: Not limiting packets for write buffer; > 0: will close connection if too many packets are buffered.
	public static int maxBufferedPackets = -1;
	...
	public static boolean sslSupportsSNI = true;

	// https://support.apple.com/en-us/HT208127
	
	// Updated Oct 23, 2023
	// Trust store version: 2023032800
	public static String[] sslKnownCANames = new String[] {
	...
	public static String[] sslKnownCADigests = new String[] {
